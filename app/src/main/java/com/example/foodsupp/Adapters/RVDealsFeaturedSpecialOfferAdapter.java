...
/**
 * Created by Muhammad Anas Shamsi on 12/8/18.
 */
public class RVDealsFeaturedSpecialOfferAdapter extends RecyclerView.Adapter<RVDealsViewHolder> {

    private ArrayList<Deals> dealsArrayList;
    private MainActivity mainActivity;

    public RVDealsFeaturedSpecialOfferAdapter(ArrayList<Deals> dealsArrayList, MainActivity mainActivity) {
    ...
    public RVDealsViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.rv_item_deals_featured_spe_offers, viewGroup, false);
